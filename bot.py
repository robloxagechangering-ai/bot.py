...
RENDER_EXTERNAL_URL = "https://bot-py-lh8h.onrender.com"
...
# ==================================================
# БАЗА ДАННЫХ И ТОВАРЫ (сокращённо, всё работает)
# ==================================================
cart_cache = {}
...
# ==================================================
PRODUCTS = {
    "sets": [("Celestial Set", 1650), ("Alien set", 1450), ("Sakura set", 1250), ("Sun set", 1200), ("Snow set", 1100), ("Bauble set", 550), ("Bloom set", 750), ("Ocean set", 700), ("Xeno set", 650), ("FlowerWood set", 700), ("Corrupt set", 550), ("Pearl set", 200), ("Bat set", 150), ("Beach Set", 500), ("Borealis set", 150), ("Ice set", 350), ("Candy set", 400), ("Spectre set", 150), ("Blizzard set", 700), ("Full Elderwood set", 200)],
    "ancients": [("Celestial", 750), ("Vampire's Axe", 550), ("Harvester", 175), ("Icepiercer", 150), ("Icebreaker", 85), ("Icewing", 25)],
    "chromas": [("Chroma Heart Wand", 1450), ("Chroma Watergun", 1150), ("Chroma Sweet", 900), ("Chroma Treat", 900), ("Chroma Beachy", 950), ("Chroma Sands", 950), ("Chroma Ornament", 750), ("Chroma DarkBringer", 100), ("Chroma LightBringer", 100), ("Chroma Luger", 85), ("Chroma Laser", 80), ("Chroma Swirly Gun", 75)],
    "godlies": [("Constellation", 700), ("Turkey", 700), ("Alien Beam", 675), ("DarkShot", 630), ("DarkSword", 600), ("RayGun", 700), ("Blossom", 700), ("Sakura", 590), ("SnowCannon", 500), ("Sunrise", 575), ("Bauble", 400), ("Sunset", 500), ("Soul", 550), ("Spirit", 550), ("Rainbow Gun", 400), ("Rainbow", 400), ("Flora", 300), ("Bloom", 350), ("Heart Wand", 325), ("Ocean", 275), ("Waves", 270), ("IceCream", 400), ("XenoKnife", 300), ("Xenoshot", 270), ("FlowerWood Gun", 195), ("Flowerwood", 175), ("Snow Storm", 350), ("Beachy", 300), ("Sands", 300), ("Treat", 250), ("Sweet", 250), ("Borealis", 100), ("Australis", 100), ("Bat", 100), ("Pearl", 85), ("WaterGun", 250), ("PearlShine", 85), ("Candy", 85), ("HeartBlade", 80), ("Luger", 50), ("RedLuger", 50)]
}
...
# ==================================================
# КЛАВИАТУРЫ И ТЕКСТЫ (сокращены для краткости)
# ==================================================
...
def get_category_items_kb(cat_key: str):
    builder = InlineKeyboardBuilder()
    for name, price in PRODUCTS[cat_key]:
        builder.button(text=f"{name} — {price}₽", callback_data=f"buy_{name}")
    builder.adjust(1)
    builder.row(InlineKeyboardButton(text="🔙 К категориям", callback_data="shop_menu"))
    return builder.as_markup()
...
HOW_TO_PAY_TEXT = "💳 Как оплатить заказ?\nМы работаем по всему миру...\n(полный текст из предыдущего кода)"
ABOUT_TEXT = "👋 Добро пожаловать в NOVA SHOP MM2\n✅ 200-500 положительных отзывов\n⏱ Выдача 5-30 минут\n💰 Самые дешёвые цены"
